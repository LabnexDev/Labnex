...
function generateFallbackStrategies(primarySelector: string): Array<{type: string, selector: string, method: 'css' | 'xpath'}> {
  ...
  // Verbose instructions for password field
  ...
  // Special handling for generic "checkout" term
  ...
  // Special handling for generic "finish" term – common in SauceDemo checkout
