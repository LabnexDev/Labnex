                ...
                {snippets && snippets.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        {snippets.map(snippet => (
                            <div key={snippet._id} className="bg-slate-800/60 backdrop-blur-md border border-slate-700 rounded-lg shadow-md hover:shadow-lg hover:shadow-sky-500/40 transition-all duration-300 flex flex-col group">
