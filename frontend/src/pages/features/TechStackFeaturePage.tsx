...
const TechStackFeaturePage: React.FC = () => {
  ...
  return (
    <>
      <Seo title="Labnex Tech Stack" description="Dive into the modern, scalable technology stack powering Labnex." canonical="https://www.labnex.dev/features/tech-stack" breadcrumbs={[{name:'Home',url:'https://www.labnex.dev/'},{name:'Features',url:'https://www.labnex.dev/#features'},{name:'Tech Stack',url:'https://www.labnex.dev/features/tech-stack'}]} image="https://www.labnex.dev/og-features-tech-stack.png" />
