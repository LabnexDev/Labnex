...
const NotesAndSnippetsFeaturePage: React.FC = () => {
  ...
  return (
    <>
      <Seo title="Notes & Snippets – Labnex" description="Capture ideas and manage reusable code with Labnex notes and snippet storage, integrated with AI and Discord." canonical="https://www.labnex.dev/features/notes-and-snippets" breadcrumbs={[{name:'Home',url:'https://www.labnex.dev/'},{name:'Features',url:'https://www.labnex.dev/#features'},{name:'Notes & Snippets',url:'https://www.labnex.dev/features/notes-and-snippets'}]} image="https://www.labnex.dev/og-features-notes-and-snippets.png" />
