...
const DocumentationContent: React.FC<DocumentationContentProps> = ({ selectedTopic }) => {
  ...
  return (
    <main className="flex-1 max-w-full p-4 md:p-6 bg-[var(--lnx-surface)] dark:bg-slate-800/50 backdrop-blur-md rounded-lg shadow-xl overflow-y-auto overflow-x-auto scrollbar-thin scrollbar-thumb-slate-700 scrollbar-track-slate-800/50 border border-[var(--lnx-border)] dark:border-slate-700/50">
      {isLoading && (
