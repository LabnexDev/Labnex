...
// Simple project dataconst newProject = {  name: 'CLI Test Project',  projectCode: 'CLI12',  description: 'Simple project for testing CLI browser automation'};

// SUPER SIMPLE test case that WILL pass
...
async function createFreshProject() {
  try {
    console.log('🚀 Creating a fresh project and simple test case...\n');
    
    // Step 1: Create the project
    console.log('📁 Creating project...');
    const projectResponse = await axios.post(`${API_BASE_URL}/projects`, newProject, {
      headers: {
    ...
    console.log(`   Test: ${simpleTestCase.title}`);
    console.log(`   Steps: ${simpleTestCase.steps.length} simple steps`);
